...
public partial class Ascii85EncodeViewModel : EncodingViewModelBase
{
    [RelayCommand]
    private void Encode()
    {
        ...
        else
        {
            ...
            this.Output = StringZipper.Ascii85.Encode(bytes);
        }
    }
    ...
    private void Decode()
    {
        ...
        else
        {
            ...
            try
            {
                var bytes = StringZipper.Ascii85.Decode(this.Input);
