...
{
    public partial class ViewModelState : Entity<ViewModelState>
    {
        #region 对象操作
        ...
        public static IList<ViewModelState> Search(String type, String key, PageParameter page)
        {
        ...
        //static readonly FieldCache<ViewModelState> _CategoryCache = new FieldCache<ViewModelState>(nameof(Category))
        //{
