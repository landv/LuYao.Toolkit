...
{
    public partial class RdpGroup : Entity<RdpGroup>
    {
        #region 对象操作
        static RdpGroup()
        {
        ...
        //static readonly FieldCache<RdpGroup> _CategoryCache = new FieldCache<RdpGroup>(nameof(Category))
        //{
        ...
        public static IList<RdpGroup> GetAllGroups()
        {
